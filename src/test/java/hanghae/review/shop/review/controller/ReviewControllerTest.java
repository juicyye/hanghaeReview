...
//    @BeforeEach
//    void setUp() {
//        ProductEntity productEntity = productRepository.save(createProductEntity(2, 2L));
...
//        // given
//        Long productId = 1L;
//        ReviewCreateReqDto request = new ReviewCreateReqDto(3L, 2, "내용");
//
//        // when
...
//        // given
//        ReviewCreateReqDto request = new ReviewCreateReqDto(1L, 2, "내용");
//
//        // when
...
//            // given
//            ReviewCreateReqDto request = new ReviewCreateReqDto(null, 2, "내용");
//
//            // when
//            ResultActions resultActions = mockMvc.perform(post("/products/{productId}/reviews", 3L)
//                            .content(objectMapper.writeValueAsString(request)).contentType(MediaType.APPLICATION_JSON))
...
//            // given
//            ReviewCreateReqDto request = new ReviewCreateReqDto(1L, 5, "내용");
//
//            // when
//            ResultActions resultActions = mockMvc.perform(post("/products/{productId}/reviews", 3L)
//                            .content(objectMapper.writeValueAsString(request)).contentType(MediaType.APPLICATION_JSON))
...
//            // given
//            ReviewCreateReqDto request = new ReviewCreateReqDto(1L, 5, "내");
//
//            // when
//            ResultActions resultActions = mockMvc.perform(post("/products/{productId}/reviews", 3L)
//                            .content(objectMapper.writeValueAsString(request)).contentType(MediaType.APPLICATION_JSON))
